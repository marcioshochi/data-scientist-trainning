...
spark = SparkSession.builder.master("local").appName("combine_supplement").getOrCreate()
...
drivers = spark.read.parquet("/duocar/clean/demographics") \
...
riders = spark.read.parquet("/duocar/clean/demographics") \
...
weather = spark.read.parquet("/duocar/clean/weather")
